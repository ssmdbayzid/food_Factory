...
const Header = () => {
  ...
  {/*//*  Responsibe Navigation bar */}
    ...
    <div className={`absolute top-14 bg-slate-600 ${open ? "-right-[380px]" : "right-0"} w-full mx-auto z-20 pb-8 transition-all duration-500 ease-in justify-between text-white items-center lg:hidden `}>
          <ul className=' '>
