...
const Make_Resurvation = () => {
  ...
  return (<div style={{background: 'url("https://i.ibb.co/3FGLWY9/burger-4614022-960-720.jpg")', backgroundRepeat:"no-repeat", backgroundSize: "cover"}} className="w-full  mt-24 pb-24 md:h-[120vh] bg-no-repeat bg-blur  bg-auto md:bg-cover ">
      ...
      <div className="items-center  lg:mb-0 md:justify-between md:flex mt-10 px-16">
        <div className="px-1">
        ...
        <div className="card flex-shrink-0  rounded-sm w-full max-w-md shadow-2xl bg-base-100 ">
      <div className="card-body ">
        <h1 className="text-[5vh] text-center text-primary font-bold">Contact Us</h1>
