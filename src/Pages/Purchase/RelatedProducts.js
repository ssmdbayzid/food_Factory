...
<div className="w-full text-secondary my-5 mx-auto max-w-sm  border  rounded-lg shadow  border-gray-700">
    <a href="#" >
        <img className="px-10 rounded-t-lg" src="https://i.ibb.co/vHhRwHr/c3.png" alt="product image" />
    </a>
    <div className="px-5 pb-5">
        ...
        {rating}
            <p className="text-3xl">Price &nbsp; : <span className=" text-primary ">$599</span></p>      
            <br />            
            {/* <NavLink to={`/purchase/${product._id}`} className=""> */}
            <NavLink to={`/purchase/63e923afffc07097ee3a59d3`} className="">
      <Button>
        Add To Cart
      </Button>
    </NavLink>      
