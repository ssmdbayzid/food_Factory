...
const Banner = () => {
  return (<div className="hero w-full md:h-[70vh] h-full" style={{ backgroundImage: `url("https://cdn.pixabay.com/photo/2022/04/30/19/12/cooking-banner-7166200_960_720.jpg")`}}>
  <div className="hero-content flex-col lg:flex-row">
    <div className='md:w-1/2 lg:p-20 md:py-0 py-5'>
